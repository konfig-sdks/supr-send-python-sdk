...
class BaseApi(api_client.Api):
    ...
    def _get_all_lists_mapped_args(
        self,
    ...
    async def _aget_all_lists_oapg(
        self,
...
class GetAllListsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_lists(
        self,
        limit: typing.Optional[str] = None,
        offset: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_all_lists_mapped_args(
            limit=limit,
            offset=offset,
        )
        return await self._aget_all_lists_oapg(
...
class GetAllLists(BaseApi):
    ...
    async def aget_all_lists(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_lists(
            limit=limit,
            offset=offset,
            **kwargs,
        )
    ...
    def get_all_lists(
        ...
        raw_response = self.raw.get_all_lists(
            limit=limit,
            offset=offset,
        )
        if validate:
