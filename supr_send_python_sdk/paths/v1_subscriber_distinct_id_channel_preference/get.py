...
class BaseApi(api_client.Api):
    ...
    def _get_user_channel_preferences_mapped_args(
        self,
        distinct_id: str,
    ...
    async def _aget_user_channel_preferences_oapg(
        self,
    ...
    def _get_user_channel_preferences_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUserChannelPreferencesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_channel_preferences(
        self,
        distinct_id: str,
        tenant_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_user_channel_preferences_mapped_args(
            distinct_id=distinct_id,
            tenant_id=tenant_id,
        )
        return await self._aget_user_channel_preferences_oapg(
    ...
    def get_user_channel_preferences(
        ...
        return self._get_user_channel_preferences_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserChannelPreferences(BaseApi):
    ...
    async def aget_user_channel_preferences(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_channel_preferences(
            distinct_id=distinct_id,
            tenant_id=tenant_id,
            **kwargs,
        )
    ...
    def get_user_channel_preferences(
        ...
        raw_response = self.raw.get_user_channel_preferences(
            distinct_id=distinct_id,
            tenant_id=tenant_id,
        )
        if validate:
