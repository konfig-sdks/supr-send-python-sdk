...
class BaseApi(api_client.Api):
    ...
    def _brand_data_get_mapped_args(
        self,
        brand_id: str,
    ...
    async def _abrand_data_get_oapg(
        self,
...
class BrandDataGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abrand_data_get(
        self,
        brand_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._brand_data_get_mapped_args(
            brand_id=brand_id,
        )
        return await self._abrand_data_get_oapg(
    ...
    def brand_data_get(
        ...
        return self._brand_data_get_oapg(
            path_params=args.path,
        )

class BrandDataGet(BaseApi):
    ...
    async def abrand_data_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.abrand_data_get(
            brand_id=brand_id,
            **kwargs,
        )
        if validate:
    ...
    def brand_data_get(
        ...
        raw_response = self.raw.brand_data_get(
            brand_id=brand_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
