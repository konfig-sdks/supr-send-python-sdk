...
class BaseApi(api_client.Api):
    ...
    def _list_start_sync_mapped_args(
        self,
        list_id: str,
    ...
    async def _alist_start_sync_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriber_list/{list_id}/start_sync',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListStartSyncRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_start_sync(
        self,
        list_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_start_sync_mapped_args(
            list_id=list_id,
        )
        return await self._alist_start_sync_oapg(
    ...
    def list_start_sync(
        ...
        return self._list_start_sync_oapg(
            path_params=args.path,
        )

class ListStartSync(BaseApi):
    ...
    async def alist_start_sync(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_start_sync(
            list_id=list_id,
            **kwargs,
        )
        if validate:
    ...
    def list_start_sync(
        ...
        raw_response = self.raw.list_start_sync(
            list_id=list_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
