...
class BaseApi(api_client.Api):
    ...
    def _finish_sync_draft_version_mapped_args(
        self,
        list_id: str,
        version_id: str,
    ...
    async def _afinish_sync_draft_version_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriber_list/{list_id}/version/{version_id}/finish_sync',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _finish_sync_draft_version_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class FinishSyncDraftVersionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afinish_sync_draft_version(
        self,
        list_id: str,
        version_id: str,
        **kwargs,
        ...
        args = self._finish_sync_draft_version_mapped_args(
            list_id=list_id,
            version_id=version_id,
        )
        return await self._afinish_sync_draft_version_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def finish_sync_draft_version(
        self,
        list_id: str,
        version_id: str,
    ) -> typing.Union[
        ...
        return self._finish_sync_draft_version_oapg(
            path_params=args.path,
        )

class FinishSyncDraftVersion(BaseApi):
    ...
    async def afinish_sync_draft_version(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afinish_sync_draft_version(
            list_id=list_id,
            version_id=version_id,
            **kwargs,
        )
    ...
    def finish_sync_draft_version(
        ...
        raw_response = self.raw.finish_sync_draft_version(
            list_id=list_id,
            version_id=version_id,
        )
        if validate:
