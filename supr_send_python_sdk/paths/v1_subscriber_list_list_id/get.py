...
class BaseApi(api_client.Api):
    ...
    def _get_list_data_mapped_args(
        self,
        list_id: str,
    ...
    async def _aget_list_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriber_list/{list_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetListDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_list_data(
        self,
        list_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_list_data_mapped_args(
            list_id=list_id,
        )
        return await self._aget_list_data_oapg(
    ...
    def get_list_data(
        ...
        return self._get_list_data_oapg(
            path_params=args.path,
        )

class GetListData(BaseApi):
    ...
    async def aget_list_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_list_data(
            list_id=list_id,
            **kwargs,
        )
        if validate:
    ...
    def get_list_data(
        ...
        raw_response = self.raw.get_list_data(
            list_id=list_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
