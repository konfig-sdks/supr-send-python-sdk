...
class BaseApi(api_client.Api):
    ...
    def _get_user_preferences_all_categories_mapped_args(
        self,
        distinct_id: str,
    ...
    async def _aget_user_preferences_all_categories_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriber/{distinct_id}/category',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_user_preferences_all_categories_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUserPreferencesAllCategoriesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_preferences_all_categories(
        self,
        distinct_id: str,
        tenant_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_user_preferences_all_categories_mapped_args(
            distinct_id=distinct_id,
            tenant_id=tenant_id,
        )
        return await self._aget_user_preferences_all_categories_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_user_preferences_all_categories(
        self,
        distinct_id: str,
        tenant_id: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_user_preferences_all_categories_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserPreferencesAllCategories(BaseApi):
    ...
    async def aget_user_preferences_all_categories(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_preferences_all_categories(
            distinct_id=distinct_id,
            tenant_id=tenant_id,
            **kwargs,
        )
    ...
    def get_user_preferences_all_categories(
        ...
        raw_response = self.raw.get_user_preferences_all_categories(
            distinct_id=distinct_id,
            tenant_id=tenant_id,
        )
        if validate:
