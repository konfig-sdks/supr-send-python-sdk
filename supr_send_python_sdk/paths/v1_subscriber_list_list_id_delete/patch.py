    ...
    async def _adelete_list_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/subscriber_list/{list_id}/delete',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeleteListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_list(
        self,
        list_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_list_mapped_args(
            list_id=list_id,
        )
        return await self._adelete_list_oapg(
...
class DeleteList(BaseApi):
    ...
    async def adelete_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_list(
            list_id=list_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_list(
        ...
        raw_response = self.raw.delete_list(
            list_id=list_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
