...
from supr_send_python_sdk.pydantic.broadcast_trigger_message_list_request_channels import BroadcastTriggerMessageListRequestChannels

class BroadcastTriggerMessageListRequest(BaseModel):
    ...
    channels: typing.Optional[BroadcastTriggerMessageListRequestChannels] = Field(None, alias='channels')
