...
class TemplateGetDetailsResponseChannelsItemVersionsItemTemplatesItemUpdatedBy(
    schemas.DictSchema
):
    """
    ...
    ) -> 'TemplateGetDetailsResponseChannelsItemVersionsItemTemplatesItemUpdatedBy':
